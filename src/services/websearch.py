...
async def perform_web_search(query: str, *, max_results: int = DEFAULT_MAX_RESULTS) -> dict[str, Any]:
    ...
    if GOOGLE_API_KEY and GOOGLE_CSE_ID:
        try:
            ...
            logger.warning("Google Custom Search failed, falling back to DuckDuckGo: %s", exc)
